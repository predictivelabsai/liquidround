...
Edition generated **2026-07-27 06:45 EEST**

Document slug: `liquidround-ai-platform-demo-20260727T034533Z`

LiquidRound v0.5.0 · Predictive Labs Ltd · **liquidround.ai**
...
2. Run a company profile or deep-research prompt and open the resulting artifact.
...
- **Right pane:** news and agent artifacts such as tables, charts, citations, and PDFs.
...
Artifacts produced in the right pane include company profiles, result tables, citations,
scoring matrices, charts, and memo/PDF previews. Use **Copy** to copy the conversation
and **Share** to create a read-only session link.
...
This document was generated from the platform state inspected on **2026-07-27**.
...
LiquidRound v0.5.0 — Predictive Labs Ltd

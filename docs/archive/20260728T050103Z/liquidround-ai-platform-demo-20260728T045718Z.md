...
Edition generated **2026-07-28 07:55 EEST**
...
and investor-relations professionals. It combines 30 specialist agents across 7 categories,
guided tools, live market data, document workflows, and exportable work products in one
workspace.
...
|---|---|
| Described 23 agents in Daily Radar and only one public-markets agent | Documents all 30 registered agents across 7 categories |
| Had no dedicated investor-relations agent category | Features a dedicated **Investor Relations & Communications** category with 5 agents |
| Had no IR triage, compliance, publish, or distribution agents | Includes `ir-triage:`, `ir-compliance:`, `ir-publish:`, and `ir-distribute:` specialists |
...
### The IR agent squad — full disclosure lifecycle

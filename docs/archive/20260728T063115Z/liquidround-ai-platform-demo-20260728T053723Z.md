...
<p class="subtitle">30 specialist agents · 7 categories · chat-first workspace</p>
<p class="meta">Predictive Labs Ltd · LiquidRound v0.5.1</p>
...
Sign in at **liquidround.ai** — choose Buyer-Led or Seller-Led. Three panes: **left** (sessions, 30 agents, Tools, IR, Public Markets), **centre** (routed chat, workspace pages), **right** (live News feed).

On mobile, the left pane becomes a slide-in menu.

![Three-pane workspace — buyer view](../screenshots/07-app-buyer.png)
...
![Press Release Creator — full form](../screenshots/20-ir-press-release-form.png)
...
## The 30-agent squad — sourcing and underwriting
...
![Agent directory](../screenshots/03-agents.png)

---

## The 30-agent squad — diligence and capital
...
![Agent detail — Deal Triage](../screenshots/04-agent-detail.png)

---

## The 30-agent squad — research and public markets

**Research & Post-Deal (2):** Deep Research Analyst (`research:`), Integration Planner (`integrate:`).

**Public Markets (3):** Hedge Fund Analyst (`hedgefunds:`), Filing Analyst (`filings:`), Press Release Analyst (`releases:`).

**Investor Relations (5):** IR Triage, Press Release Writer, IR Compliance, IR Publish, IR Distribution.

![Agent browser expanded](../screenshots/09-agent-browser.png)
...
![Deal Triage in chat](../screenshots/10-chat-triage.png)
...
![IPO readiness assessment in chat](../screenshots/13-chat-ipo.png)
...
![Platform overview](../screenshots/02-platform.png)
...
![Seller workspace](../screenshots/08-app-seller.png)
...
![Settings and configuration](../screenshots/14-settings.png)
...
![Pricing](../screenshots/06-pricing.png)
...
![Sign in page](../screenshots/18-signin.png)
